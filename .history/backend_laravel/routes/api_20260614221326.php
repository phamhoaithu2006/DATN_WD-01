...
Hành độngPhương thứcURLLấy danh sáchGEThttp://127.0.0.1:8000/api/destinationsXem chi tiếtGEThttp://127.0.0.1:8000/api/destinations/{id}Thêm mớiPOSThttp://127.0.0.1:8000/api/destinationsCập nhậtPUT/PATCHhttp://127.0.0.1:8000/api/destinations/{id}XóaDELETEhttp://127.0.0.1:8000/api/destinations/{id}
