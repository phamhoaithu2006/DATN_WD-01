...
// Sử dụng prefix 'guide' để quản lý các route liên quan đến HDV dễ dàng hơn
Route::middleware('auth:sanctum')->prefix('guide')->group(function () {
    
    // Route hiển thị thông tin profile
    Route::get('/profile', [GuideProfileController::class, 'getProfile']);
    
    // Bạn có thể mở rộng thêm các route khác sau này tại đây
    // Route::put('/update', [GuideProfileController::class, 'update']);
});
