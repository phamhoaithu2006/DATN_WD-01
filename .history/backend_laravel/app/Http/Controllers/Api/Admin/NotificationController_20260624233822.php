...
class NotificationController extends Controller
{
    ...
    {
        // Lấy toàn bộ dữ liệu trong bảng notifications
        $history = \App\Models\Notification::with('user:id,full_name') // Tùy chọn: lấy kèm tên người nhận
            ->orderBy('created_at', 'desc')
            ->get();

        return response()->json([
            'message' => 'Lịch sử chi tiết các thông báo đã gửi',
            'data' => $history
        ], 200);
    }
}
