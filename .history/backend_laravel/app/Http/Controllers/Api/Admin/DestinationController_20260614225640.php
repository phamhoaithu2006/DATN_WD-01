...
class DestinationController extends Controller
{
    ...
    /**
     * 9. Tìm kiếm danh sách địa điểm theo từ khóa và các bộ lọc
     * * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function search(Request $request)
    {
        // Khởi tạo đối tượng query để xây dựng câu lệnh SQL linh hoạt
        $query = Destination::query();

        // Logic tìm kiếm theo từ khóa (keyword)
        // Sử dụng where theo cụm (closure) để đảm bảo điều kiện tìm kiếm 
        // không bị ảnh hưởng bởi các điều kiện WHERE khác bên ngoài
        ...
        // Bộ lọc theo quốc gia (nếu người dùng có cung cấp)
