...
class DestinationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // 4. Tạo mới và trả về dữ liệu vừa tạo với mã trạng thái 201 (Created)
        return response()->json(Destination::create($data), 201);
    }


    /**
     * 5. Cập nhật thông tin của một điểm đến theo ID.
     * * @param  \Illuminate\Http\Request  $request
     * @param  int  $id
     * @return \Illuminate\Http\JsonResponse
     */
    ...
    /**
     * 2. Hiển thị danh sách các bản ghi đã xóa mềm
