...
{
    // Đếm số lượng user có role_id = 2
    ...
    /**
 * Xem chi tiết thông tin khách hàng dựa trên ID.
 * * @param int $id
 * @return JsonResponse
 */
public function show($id): JsonResponse
{
    // Tìm User theo ID và kiểm tra xem có phải là khách hàng (role_id = 2) không
    ...
    // Nếu tìm thấy, trả về dữ liệu khách hàng
    return response()->json([
        'status' => 'success',
        'data' => $customer
    ], 200);
