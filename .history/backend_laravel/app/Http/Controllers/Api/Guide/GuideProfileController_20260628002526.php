    ...
    public function show(Request $request)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'languages' => $guide->guideLanguages->map(fn($guideLanguages) => [
                    'id' => $guideLanguages->id,
                    'name' => $guideLanguages->name,
                    'level_id' => $guideLanguages->pivot->level_id, // Lấy trình độ ngôn ngữ từ bảng pivot
                ]),
