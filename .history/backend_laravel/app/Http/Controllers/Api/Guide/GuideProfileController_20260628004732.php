...
class GuideProfileController extends Controller
{
    ...
    //Sửa pass khi nhớ pass ()
    public function changePassword(Request $request)
    {
        // 1. Validate dữ liệu đầu vào từ phía người dùng
        $request->validate([
            'old_password' => 'required|string',
            // 'confirmed' yêu cầu phải có field 'new_password_confirmation' gửi kèm từ frontend
            'new_password' => 'required|string|min:6|confirmed',
        ], [
            // Tùy chỉnh thông báo lỗi (Custom messages)
        ...
        // 3. Kiểm tra mật khẩu cũ có khớp với dữ liệu trong Database không
        ...
        // 4. Cập nhật mật khẩu mới (đã được băm/mã hóa bằng Hash::make)
        $user->update([
