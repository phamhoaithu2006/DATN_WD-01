...
Tài liệu này là mục lục tổng hợp của quá trình đối chiếu Business Model trong `docs/reverse-engineering`. Audit ban đầu dùng commit `d9ddfd25c02d94ebfd1cd12ce42341cfbeaa6219`; kết quả hậu sửa ngày 2026-07-22 dùng working tree của nhánh `fix/business-model-audit-bugs`, kế thừa commit tài liệu `044d8cd59083e5f7ca5a1a202b0fdc581be47bc5`.
...
- 437 test case trong catalog vẫn là **thiết kế test**. Riêng 15 BUG đã có regression test runtime: test mục tiêu đạt 72 test/353 assertion trên SQLite và MySQL; sáu test concurrency đa tiến trình đạt 15 assertion trên MySQL.
- Có 15 BUG ID lịch sử: 1 Critical, 11 High, 3 Medium, 0 Low; cả 15 có disposition hậu sửa **Resolved**. Diagnosis cũ không bị xóa.
- Full Pest hiện có 139 test đạt, 1 test lỗi do conflict marker có sẵn trong `ServiceCategorySeeder.php` (`UV-018`) và 6 test concurrency MySQL-only bị skip trên SQLite.
...
- [Bằng chứng xác minh hậu sửa](11-post-fix-verification.md)
...
| [Phân công và vận hành guide](modules/04-guide-operations.md) | BR-054–BR-073 | 20 Đúng | [TC-GOP-001–TC-GOP-073](test-cases/04-guide-operations-test-cases.md) | BUG-RG-001–BUG-RG-004 — Resolved |
| [Support và notification](modules/05-support-notifications.md) | BR-074–BR-084 | 11 Đúng | [TC-SA-074-01–TC-SA-084-04](test-cases/05-support-notifications-test-cases.md) | BUG-SA-001, BUG-SA-004 — Resolved |
| [Nền tảng quản trị](modules/06-admin-platform.md) | BR-085–BR-096 | 12 Đúng | [TC-SA-085-01–TC-SA-096-08](test-cases/06-admin-platform-test-cases.md) | BUG-SA-002, BUG-SA-003 — Resolved |
| [Yêu cầu xuyên tài liệu](modules/07-cross-document-requirements.md) | SR-001–SR-013 | 13 Đúng | [TC-XD-001–TC-XD-080](test-cases/07-supplemental-test-cases.md) | BUG-XD-001–BUG-XD-003 — Resolved |
