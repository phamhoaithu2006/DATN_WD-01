...
const policies = {
  ...
  payment: { title: 'Chính sách thanh toán', intro: 'Hướng dẫn thanh toán an toàn cho booking trên ViVuGo.', sections: [['Phương thức thanh toán', ['Khách hàng thanh toán trực tuyến qua cổng VNPAY hoặc theo phương thức được hiển thị tại thời điểm đặt tour.']], ['Thời hạn thanh toán', ['Link thanh toán VNPAY có hiệu lực trong thời hạn hiển thị trên hệ thống.', 'Chỗ chỉ được xác nhận sau khi hệ thống nhận được thông báo thanh toán thành công.']]] },
  booking: { title: 'Chính sách đặt tour', intro: 'Quy trình xác nhận thông tin và xác nhận chỗ cho chuyến đi.', sections: [['Xác nhận booking', ['Booking được tạo sau khi khách hàng hoàn thành thông tin liên hệ và hành khách.', 'Chỗ của lịch khởi hành chỉ được trừ sau khi thanh toán thành công và hệ thống kiểm tra lại số chỗ.']], ['Thông tin hành khách', ['Khách hàng cần cung cấp đúng họ tên, ngày sinh và giấy tờ theo yêu cầu của tour.']]] },
