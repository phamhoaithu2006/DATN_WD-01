...
function BookingTrashPage() {
  ...
  return (
    <section className="booking-management-page">
      <AdminPageHeader breadcrumb={['ViVuGo', 'Booking', 'Quản Lý Booking', 'Thùng rác']} title="Booking đã xóa mềm" description="Xem chi tiết, hoàn tác hoặc xóa vĩnh viễn booking." actions={<button type="button" className="booking-trash-page-button" onClick={() => navigate('/admin/bookings')}>Quay lại danh sách</button>} />
