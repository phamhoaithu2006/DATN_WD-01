...
useEffect(() => {
  ...
  const validateForm = () => {
    ...
    if (form.target_type === 'role' && selectedRoleIds.length === 0) {
            ...
            {form.target_type === 'role' && (
                <div className="rounded-2xl border border-violet-200 bg-violet-50 p-4">
                    ...
                    <div>
                        ...
                        Thông báo sẽ được gửi cho toàn bộ người dùng thuộc các vai trò đã chọn.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="rounded-lg border border-violet-200 bg-white px-3 py-2 text-xs font-bold text-violet-700 transition hover:bg-violet-100"
                    >
                        {selectedRoleIds.length === roles.length
                        ? 'Bỏ chọn tất cả'
                        : 'Chọn tất cả'}
                    ...
                    {loadingRoles ? (
                    <p className="py-4 text-sm text-violet-700">
                        Đang tải vai trò...
                    </p>
                    ) : roles.length === 0 ? (
                    <p className="py-4 text-sm text-violet-700">
                    ...
                    <p className="mt-4 text-xs font-bold text-violet-700">
