...
class PartnerServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $services = [
            ...
            // Partner 3 - Vận tải Sao Việt (van-chuyen)
            [
                'partner_id'                  => 3,
                'service_name'                => 'Xe Limousine 16 chỗ',
                'service_code'                => 'SV-LIM16',
                'service_type'                => 'transport',
                'depart_time'                 => '07:00',
                'arrive_time'                 => null,
                'origin'                      => 'TP.HCM',
                'destination'                 => 'Đà Lạt',
                'vehicle_type'                => 'Limousine 16 chỗ',
                'seat_class'                  => 'VIP',
                'operate_days'                => json_encode([1, 3, 5, 6, 7]),
                'domestic_booking_hours'      => 2,
                'international_booking_hours' => null,
                'confirmation_time'           => '30 phút',
                'amenities'                   => json_encode(['WiFi', 'Nước miễn phí', 'Điều hoà']),
                'status'                      => 'active',
                'created_at'                  => $now,
                'updated_at'                  => $now,
            ],
            [
                'partner_id'                  => 3,
                'service_name'                => 'Xe 45 chỗ đoàn tour',
                'service_code'                => 'SV-BUS45',
                'service_type'                => 'transport',
                'depart_time'                 => '06:00',
                'arrive_time'                 => null,
                'origin'                      => 'TP.HCM',
                ...
                'international_booking_hours' => null,
                'confirmation_time'           => '1 giờ',
                'amenities'                   => json_encode(['Điều hoà', 'Micro']),
                'status'                      => 'active',
                'created_at'                  => $now,
                'updated_at'                  => $now,
            ],
