...
{
    //Hiển thị danh sách thông báo của khách hàng (I)
    ...
    //khi họ click vào thông báo, trạng thái sẽ chuyển từ unread sang read. (III)
    ...
    //hiển thị số lượng thông báo chx đọc (IV)
